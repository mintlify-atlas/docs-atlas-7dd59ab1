...
description: "Referencia completa de las custom properties CSS: paleta de colores y tipografía de la IEM Emilio Cifuentes, con valores exactos de cada token."
---
